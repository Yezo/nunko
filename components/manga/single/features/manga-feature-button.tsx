...
import { CreateMangaEntryForm } from "@/components/forms/manga-entry/create-manga-entry"
import { EditMangaEntryForm } from "@/components/forms/manga-entry/edit-manga-entry"

type MangaListFeatureButtonProps = {
...
export const MangaListFeatureButton = ({
  children,
  title,
  data,
  added,
